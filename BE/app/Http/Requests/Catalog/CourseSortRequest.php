...
class CourseSortRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'sort' => [
                'nullable',
                'string',
                'in:latest,price_asc,price_desc,rating_desc,best_selling,featured',
            ],
    ...
    {
        return [
            'sort.string' => 'Giá trị sắp xếp không hợp lệ.',
            ...
            'level.string' => 'Cấp độ khóa học không hợp lệ.',
            'level.in' => 'Cấp độ khóa học không hợp lệ.',

            'language.string' => 'Ngôn ngữ không hợp lệ.',
