...
class CourseResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'requirements' => (is_array($this->requirements) ? $this->requirements : (json_decode((string) ($this->requirements ?? '[]'), true) ?? [])) ?? $this->requirements,
            'outcomes' => (is_array($this->outcomes) ? $this->outcomes : (json_decode((string) ($this->outcomes ?? '[]'), true) ?? [])) ?? $this->outcomes,
