...
CREATE TABLE categories (
    ...
    sort_order VARCHAR(255) NOT NULL DEFAULT 'a',
...
INSERT INTO categories (id, parent_id, name, slug, description, sort_order, status, created_at, updated_at, deleted_at) VALUES
    (1, NULL, 'Lập trình', 'lap-trinh', 'Các khóa học lập trình từ cơ bản đến nâng cao.', 'a', 'active', '2026-01-03 08:00:00', '2026-01-03 08:00:00', NULL),
    (2, 1, 'Web Development', 'web-development', 'Frontend, backend và full-stack web.', 'a', 'active', '2026-01-03 08:05:00', '2026-01-03 08:05:00', NULL),
    (3, 1, 'Backend', 'backend', 'API, cơ sở dữ liệu, bảo mật backend.', 'b', 'active', '2026-01-03 08:10:00', '2026-01-03 08:10:00', NULL),
    (4, 1, 'Frontend', 'frontend', 'Giao diện người dùng hiện đại.', 'c', 'active', '2026-01-03 08:15:00', '2026-01-03 08:15:00', NULL),
    (5, NULL, 'AI và Dữ liệu', 'ai-va-du-lieu', 'AI ứng dụng, phân tích dữ liệu và tự động hóa.', 'b', 'active', '2026-01-03 08:20:00', '2026-01-03 08:20:00', NULL),
    (6, NULL, 'DevOps', 'devops', 'Triển khai, Docker, CI/CD và vận hành.', 'c', 'active', '2026-01-03 08:25:00', '2026-01-03 08:25:00', NULL),
    (7, NULL, 'Kinh doanh số', 'kinh-doanh-so', 'Danh mục inactive để test filter public.', 'd', 'inactive', '2026-01-03 08:30:00', '2026-01-03 08:30:00', NULL);
...
INSERT INTO categories (id, parent_id, name, slug, description, sort_order, status, created_at, updated_at, deleted_at) VALUES
    (8, NULL, 'AI & Học tập thông minh', 'ai-hoc-tap-thong-minh', 'Danh mục demo MindHub: AI & Học tập thông minh.', 'h', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (9, 8, 'AI Learning', 'ai-learning', 'Danh mục demo MindHub: AI Learning.', 'a', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (10, NULL, 'Backend & API Testing', 'backend-api-testing', 'Danh mục demo MindHub: Backend & API Testing.', 'i', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (11, 10, 'Postman API Testing', 'postman-api-testing', 'Danh mục demo MindHub: Postman API Testing.', 'a', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (12, NULL, 'Công cụ lập trình & Làm việc nhóm', 'cong-cu-lap-trinh-lam-viec-nhom', 'Danh mục demo MindHub: Công cụ lập trình & Làm việc nhóm.', 'j', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (13, 12, 'Git & GitHub', 'git-github', 'Danh mục demo MindHub: Git & GitHub.', 'a', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (14, NULL, 'Database & Data Modeling', 'database-data-modeling', 'Danh mục demo MindHub: Database & Data Modeling.', 'k', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (15, 14, 'MySQL Database Design', 'mysql-database-design', 'Danh mục demo MindHub: MySQL Database Design.', 'a', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (16, NULL, 'DevOps & Triển khai', 'devops-trien-khai', 'Danh mục demo MindHub: DevOps & Triển khai.', 'l', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (17, 16, 'Deploy VPS aaPanel', 'deploy-vps-aapanel', 'Danh mục demo MindHub: Deploy VPS aaPanel.', 'a', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (18, NULL, 'Frontend UI UX', 'frontend-ui-ux', 'Danh mục demo MindHub: Frontend UI UX.', 'm', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (19, 18, 'Tailwind CSS', 'tailwind-css', 'Danh mục demo MindHub: Tailwind CSS.', 'a', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (20, NULL, 'Kinh doanh số & Freelance Web', 'kinh-doanh-so-va-freelance-web', 'Danh mục demo MindHub: Kinh doanh số & Freelance Web.', 'n', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (21, 20, 'Freelance Web Developer', 'freelance-web-developer', 'Danh mục demo MindHub: Freelance Web Developer.', 'a', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (22, 20, 'Sản phẩm số & SaaS', 'san-pham-so-va-saas', 'Danh mục demo MindHub: Sản phẩm số & SaaS.', 'b', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (23, NULL, 'Kỹ năng mềm cho lập trình viên', 'ky-nang-mem-cho-lap-trinh-vien', 'Danh mục demo MindHub: Kỹ năng mềm cho lập trình viên.', 'o', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (24, 23, 'Giao tiếp & Làm việc nhóm', 'giao-tiep-va-lam-viec-nhom', 'Danh mục demo MindHub: Giao tiếp & Làm việc nhóm.', 'a', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (25, 23, 'Tư duy nghề nghiệp & Phỏng vấn', 'tu-duy-nghe-nghiep-va-phong-van', 'Danh mục demo MindHub: Tư duy nghề nghiệp & Phỏng vấn.', 'b', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (26, NULL, 'Lập trình Web', 'lap-trinh-web', 'Danh mục demo MindHub: Lập trình Web.', 'p', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (27, 26, 'Backend Laravel', 'backend-laravel', 'Danh mục demo MindHub: Backend Laravel.', 'a', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (28, 26, 'Frontend React', 'frontend-react', 'Danh mục demo MindHub: Frontend React.', 'b', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (29, NULL, 'Marketing Internet cho Web Developer', 'marketing-internet-cho-web-developer', 'Danh mục demo MindHub: Marketing Internet cho Web Developer.', 'q', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (30, 29, 'Landing Page & Conversion', 'landing-page-va-conversion', 'Danh mục demo MindHub: Landing Page & Conversion.', 'a', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (31, 29, 'SEO & Content Website', 'seo-va-content-website', 'Danh mục demo MindHub: SEO & Content Website.', 'b', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (32, NULL, 'Payment & E-commerce', 'payment-e-commerce', 'Danh mục demo MindHub: Payment & E-commerce.', 'r', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (33, 32, 'VNPay Laravel', 'vnpay-laravel', 'Danh mục demo MindHub: VNPay Laravel.', 'a', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (34, NULL, 'Định hướng nghề nghiệp & Phỏng vấn', 'dinh-huong-nghe-nghiep-phong-van', 'Danh mục demo MindHub: Định hướng nghề nghiệp & Phỏng vấn.', 's', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (35, 34, 'Lộ trình Web Developer', 'lo-trinh-web-developer', 'Danh mục demo MindHub: Lộ trình Web Developer.', 'a', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL),
    (36, 34, 'Phỏng vấn Backend Developer', 'phong-van-backend-developer', 'Danh mục demo MindHub: Phỏng vấn Backend Developer.', 'b', 'active', '2026-06-27 08:00:00', '2026-06-27 08:00:00', NULL);
