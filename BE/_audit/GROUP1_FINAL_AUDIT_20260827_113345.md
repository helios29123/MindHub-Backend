...
**Generated:** 2026-08-27T11:33:53
**App root:** `D:\laragon\www\datn\MindHub-Backend\BE`
**Git root:** `D:\laragon\www\datn\MindHub-Backend`
**Branch:** `be-database-new`
**Commit:** `210d3283db29b2e286ee7e4d3ad935516483f495`

# KẾT LUẬN: PASS

## 1. BLOCKERS
- Không có blocker Group 1.

## 2. WARNINGS
- Có file backup cũ đang bị git đánh dấu deleted. Không phải runtime blocker, nhưng cần quyết định có muốn commit việc xóa file backup này hay không.

## 3. GROUP 1 TARGETED LEGACY SCAN
### SoftDelete field deleted_at: PASS
- CLEAN
...
### SoftDeletes trait: PASS
- CLEAN

### Category restore method: PASS
- CLEAN

### Category fake findWithTrashed: PASS
- CLEAN

### Category fake findOnlyTrashed: PASS
- CLEAN

### CourseViewService: PASS
- CLEAN

### recordView method/call: PASS
- CLEAN

### course_views table: PASS
- CLEAN

### Quiz checklist placeholder: PASS
- CLEAN

### Course legacy approved_at: PASS
- CLEAN

### Course legacy rejected_reason: PASS
- CLEAN

### Course legacy total_duration_seconds: PASS
- CLEAN
...
## 4. STALE ROUTE CHECK
### Category restore: PASS
- Không còn route.

### Course view: PASS
- Không còn route.

## 5. DELETED FILE DEPENDENCY AUDIT
### `app/Services/AdminService.php`: PASS
- Không còn exact dependency/call-site.

### `app/Services/CoursePublicService.php`: PASS
- Không còn exact dependency/call-site.

### `app/Services/InteractionService.php`: PASS
- Không còn exact dependency/call-site.

### `app/Services/MarketingService.php`: PASS
- Không còn exact dependency/call-site.

### `app/Services/ModerationService.php`: PASS
- Không còn exact dependency/call-site.

### `app/Services/QuizService.php`: PASS
- Không còn exact dependency/call-site.

### `app/Services/Course/CourseViewService.php`: PASS
- Không còn exact dependency/call-site.

## 6. PHP LINT — CHANGED PHP FILES
### `app/Http/Controllers/AdminCategoryController.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Http\Controllers\AdminCategoryController.php
```
...
### `app/Http/Controllers/InteractionController.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Http\Controllers\InteractionController.php
```

### `app/Http/Controllers/ReportController.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Http\Controllers\ReportController.php
```

### `app/Repositories/Admin/AdminCategoryRepository.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Repositories\Admin\AdminCategoryRepository.php
```

### `app/Repositories/Admin/AdminCourseRepository.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Repositories\Admin\AdminCourseRepository.php
```

### `app/Repositories/Catalog/BannerRepository.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Repositories\Catalog\BannerRepository.php
```

### `app/Repositories/Catalog/CatalogCourseRepository.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Repositories\Catalog\CatalogCourseRepository.php
```

### `app/Repositories/Catalog/CategoryRepository.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Repositories\Catalog\CategoryRepository.php
```

### `app/Repositories/Catalog/FeaturedInstructorRepository.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Repositories\Catalog\FeaturedInstructorRepository.php
```

### `app/Repositories/Instructor/InstructorCourseRepository.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Repositories\Instructor\InstructorCourseRepository.php
```

### `app/Repositories/Instructor/InstructorLearnerRepository.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Repositories\Instructor\InstructorLearnerRepository.php
```

### `app/Repositories/Instructor/InstructorLessonRepository.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Repositories\Instructor\InstructorLessonRepository.php
```

### `app/Repositories/Instructor/InstructorRevenueRepository.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Repositories\Instructor\InstructorRevenueRepository.php
```

### `app/Repositories/Interaction/InstructorQuestionRepository.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Repositories\Interaction\InstructorQuestionRepository.php
```

### `app/Repositories/Moderation/CourseModerationRepository.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Repositories\Moderation\CourseModerationRepository.php
```

### `app/Repositories/Report/InstructorDashboardAlertRepository.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Repositories\Report\InstructorDashboardAlertRepository.php
```

### `app/Repositories/Report/InstructorDashboardRepository.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Repositories\Report\InstructorDashboardRepository.php
```

### `app/Repositories/Report/InstructorEnrollmentChartRepository.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Repositories\Report\InstructorEnrollmentChartRepository.php
```

### `app/Repositories/Wishlist/WishlistRepository.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Repositories\Wishlist\WishlistRepository.php
```

### `app/Services/Admin/AdminCategoryService.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Services\Admin\AdminCategoryService.php
```

### `app/Services/Admin/AdminCourseService.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Services\Admin\AdminCourseService.php
```

### `app/Services/Admin/AdminPayoutAccountService.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Services\Admin\AdminPayoutAccountService.php
```

### `app/Services/Admin/AdminService.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Services\Admin\AdminService.php
```

### `app/Services/Catalog/CatalogService.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Services\Catalog\CatalogService.php
```

### `app/Services/Course/CourseAvailabilityService.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Services\Course\CourseAvailabilityService.php
```

### `app/Services/Course/CoursePublicService.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Services\Course\CoursePublicService.php
```

### `app/Services/Course/RelatedCourseService.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Services\Course\RelatedCourseService.php
```

### `app/Services/Faq/FaqAdminService.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Services\Faq\FaqAdminService.php
```

### `app/Services/Instructor/CourseChecklistService.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Services\Instructor\CourseChecklistService.php
```

### `app/Services/Instructor/CourseCreditService.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Services\Instructor\CourseCreditService.php
```

### `app/Services/Instructor/InstructorCourseService.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Services\Instructor\InstructorCourseService.php
```

### `app/Services/Instructor/InstructorCreditOrderService.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Services\Instructor\InstructorCreditOrderService.php
```

### `app/Services/Instructor/InstructorUpgradeService.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Services\Instructor\InstructorUpgradeService.php
```

### `app/Services/Interaction/InstructorQuestionService.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Services\Interaction\InstructorQuestionService.php
```

### `app/Services/Moderation/ModerationService.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Services\Moderation\ModerationService.php
```

### `app/Services/Report/ReportService.php` — PASS
```text
No syntax errors detected in D:\laragon\www\datn\MindHub-Backend\BE\app\Services\Report\ReportService.php
```
...
> Các hit dưới đây nằm ngoài phạm vi Group 1 đã chốt. Chúng phải được xử lý ở nhóm nghiệp vụ tương ứng, nhưng không tự động làm Group 1 FAIL.

### `deleted_at` — 71 hit(s)
- `app/Repositories/Instructor/InstructorLearnerRepository.php:380: ->whereNull('deleted_at')`
- `app/Repositories/Instructor/InstructorLearnerRepository.php:386: ->whereNull('deleted_at')`
- `app/Repositories/Instructor/InstructorLearnerRepository.php:393: $query->select('id')->from('lessons')->where('course_id', $enrollment->course_id)->whereNull('deleted_at');`
- `app/Repositories/Instructor/InstructorLearnerRepository.php:404: $query->select('id')->from('lessons')->where('course_id', $enrollment->course_id)->whereNull('deleted_at');`
- `app/Repositories/Instructor/InstructorLearnerRepository.php:411: ->whereNull('deleted_at')`
- `app/Repositories/Instructor/InstructorLearnerRepository.php:419: ->whereNull('deleted_at')`
- `app/Repositories/Instructor/InstructorLearnerRepository.php:469: ->whereNull('lessons.deleted_at')`
- `app/Repositories/Instructor/InstructorProfileRepository.php:15: ->whereNull('deleted_at')`
- `app/Repositories/Instructor/InstructorQuizRepository.php:21: ->whereNull('quizzes.deleted_at')`
- `app/Repositories/Instructor/InstructorQuizRepository.php:25: ->whereNull('deleted_at');`
- `app/Repositories/Instructor/InstructorQuizRepository.php:55: ->whereNull('quizzes.deleted_at')`
- `app/Repositories/Instructor/InstructorQuizRepository.php:59: ->whereNull('deleted_at');`
- `app/Repositories/Instructor/InstructorQuizRepository.php:69: ->whereNull('deleted_at')`
- `app/Repositories/Instructor/InstructorRevenueRepository.php:101: ->whereNull('deleted_at')`
- `app/Repositories/Instructor/InstructorRevenueRepository.php:109: ->whereNull('deleted_at')`
- `app/Repositories/Instructor/InstructorUpgradeRepository.php:86: ->whereNull('u.deleted_at')`
- `app/Repositories/Instructor/InstructorWithdrawRepository.php:17: ->whereNull('deleted_at')`
- `app/Repositories/Marketing/InstructorCouponRepository.php:96: ->whereNull('deleted_at')`
- `app/Repositories/Marketing/InstructorCouponRepository.php:105: ->whereNull('deleted_at');`
- `app/Repositories/Marketing/InstructorCouponRepository.php:123: ->whereNull('deleted_at');`
- `app/Repositories/Quiz/QuizRepository.php:16: ->whereNull('deleted_at')`
- `app/Repositories/Quiz/QuizRepository.php:34: ->whereNull('deleted_at')`
- `app/Repositories/Quiz/QuizRepository.php:43: ->whereNull('deleted_at')`
- `app/Repositories/Report/CourseAnalyticsRepository.php:17: ->whereNull('deleted_at')`
- `app/Repositories/Report/InstructorDashboardAlertRepository.php:21: if (Schema::hasColumn('notifications', 'deleted_at')) {`
- `app/Repositories/Report/InstructorDashboardAlertRepository.php:22: $query->whereNull('deleted_at');`
- `app/Repositories/Report/InstructorDashboardAlertRepository.php:77: ->whereNull('deleted_at')`
- `app/Repositories/Report/InstructorDashboardRepository.php:44: ->whereNull('deleted_at')`
- `app/Repositories/Report/InstructorTopCourseRepository.php:15: ->whereNull('deleted_at');`
- `app/Repositories/Report/LearnerRiskRepository.php:15: ->whereNull('deleted_at')`
- `app/Services/Learning/LearningService.php:26: $q->whereNull('deleted_at');`
- `app/Services/Learning/LearningService.php:297: ->whereNull('deleted_at')`
- `app/Services/Learning/LearningService.php:333: $q->where('status', 'published')->whereNull('deleted_at');`
- `app/Services/Learning/LearningService.php:591: ->whereNull('deleted_at');`
- `app/Services/Learning/LessonVideoAccessService.php:106: if (Schema::hasColumn('enrollments', 'deleted_at')) {`
- `app/Services/Learning/LessonVideoAccessService.php:107: $query->whereNull('deleted_at');`
- `app/Services/Learning/WatermarkInfoService.php:45: if (Schema::hasColumn('enrollments', 'deleted_at')) {`
- `app/Services/Learning/WatermarkInfoService.php:46: $query->whereNull('deleted_at');`
- `app/Services/Payment/CoursePurchaseGuardService.php:16: if (Schema::hasColumn('courses', 'deleted_at')) {`
- `app/Services/Payment/CoursePurchaseGuardService.php:17: $courseQuery->whereNull('deleted_at');`
- `app/Services/Payment/CoursePurchaseGuardService.php:45: if (Schema::hasColumn('enrollments', 'deleted_at')) {`
- `app/Services/Payment/CoursePurchaseGuardService.php:46: $enrollmentQuery->whereNull('deleted_at');`
- `app/Services/Payment/CoursePurchaseGuardService.php:58: if (Schema::hasColumn('orders', 'deleted_at')) {`
- `app/Services/Payment/CoursePurchaseGuardService.php:59: $paidOrderQuery->whereNull('deleted_at');`
- `app/Services/Payment/OrderService.php:45: if (Schema::hasColumn('orders', 'deleted_at')) {`
- `app/Services/Payment/OrderService.php:46: $pendingQuery->whereNull('deleted_at');`
- `app/Services/Payment/OrderService.php:136: if (Schema::hasColumn('orders', 'deleted_at')) {`
- `app/Services/Payment/OrderService.php:137: $query->whereNull('deleted_at');`
- `app/Services/Payment/OrderService.php:155: if (Schema::hasColumn('orders', 'deleted_at')) {`
- `app/Services/Payment/OrderService.php:156: $query->whereNull('deleted_at');`
- `app/Services/Payment/OrderService.php:185: if (Schema::hasColumn('orders', 'deleted_at')) {`
- `app/Services/Payment/OrderService.php:186: $query->whereNull('deleted_at');`
- `app/Services/Payment/PaymentService.php:256: if (Schema::hasColumn('orders', 'deleted_at')) {`
- `app/Services/Payment/PaymentService.php:257: $query->whereNull('deleted_at');`
- `app/Services/Payment/PaymentService.php:326: if (Schema::hasColumn('courses', 'deleted_at')) {`
- `app/Services/Payment/PaymentService.php:327: $courseQuery->whereNull('deleted_at');`
- `app/Services/Payment/PaymentService.php:458: if (Schema::hasColumn('enrollments', 'deleted_at')) {`
- `app/Services/Payment/PaymentService.php:459: $query->whereNull('deleted_at');`
- `app/Services/Report/ReportService.php:104: ->whereNull('course_reviews.deleted_at')`
- `app/Services/Report/ReportService.php:265: ->whereNull('deleted_at')`
- `app/Services/Report/ReportService.php:490: $courseQuery = DB::table('courses')->whereNull('deleted_at');`
- `app/Services/Report/ReportService.php:551: ->whereNull('deleted_at')`
- `app/Services/Report/ReportService.php:575: $pendingCourseReviews = DB::table('courses')->whereNull('deleted_at')->where('status', 'pending_review')->count();`
- `app/Services/Report/ReportService.php:581: ->whereNull('payout_accounts.deleted_at')`
- `app/Services/Report/ReportService.php:588: ->whereNull('payout_accounts.deleted_at')`
- `app/Services/Report/ReportService.php:731: ->whereNull('deleted_at')`
- `app/Http/Controllers/InstructorCouponController.php:157: ->whereNull('deleted_at');`
- `app/Http/Controllers/InstructorCouponController.php:219: ->whereNull('deleted_at')`
- `app/Http/Controllers/InteractionController.php:179: ->whereNull('deleted_at')`
- `app/Http/Controllers/InteractionController.php:201: ->whereNull('deleted_at')`
- `app/Http/Controllers/ReportController.php:339: ->whereNull('deleted_at')`

### `withTrashed` — 1 hit(s)
- `app/Repositories/Interaction/ReviewRepository.php:40: return CourseReview::withTrashed()`

### `onlyTrashed` — 0 hit(s)
- No matches

### `Quiz model refs` — 8 hit(s)
- `app/Repositories/Instructor/InstructorQuizRepository.php:6: use App\Models\Quiz;`
- `app/Repositories/Learning/DynamicAlertRepository.php:8: use App\Models\QuizAttempt;`
- `app/Repositories/Report/CourseAnalyticsRepository.php:7: use App\Models\QuizAttempt;`
- `app/Repositories/Report/LearnerRiskRepository.php:7: use App\Models\QuizAttempt;`
- `app/Services/Quiz/QuizService.php:6: use App\Models\Quiz;`
- `app/Services/Quiz/QuizService.php:7: use App\Models\QuizAttempt;`
- `app/Services/Quiz/QuizService.php:8: use App\Models\QuizAnswer;`
- `app/Services/Quiz/QuizService.php:9: use App\Models\QuizQuestion;`

### `course_views` — 5 hit(s)
- `app/Repositories/Report/InstructorDashboardRepository.php:217: if (!\Illuminate\Support\Facades\Schema::hasTable('course_views')) {`
- `app/Repositories/Report/InstructorDashboardRepository.php:225: $query = DB::table('course_views')`
- `app/Repositories/Report/InstructorDashboardRepository.php:226: ->join('courses', 'courses.id', '=', 'course_views.course_id')`
- `app/Repositories/Report/InstructorDashboardRepository.php:231: ->whereBetween('course_views.viewed_at', [$startDate->copy()->startOfDay(), $endDate->copy()->endOfDay()])`
- `app/Repositories/Report/InstructorDashboardRepository.php:239: ->whereBetween('course_views.viewed_at', [$prevStartDate->startOfDay(), $prevEndDate->endOfDay()])`

### `approved_at` — 11 hit(s)
- `app/Repositories/Instructor/InstructorWithdrawalRepository.php:51: $accountStatus = (! empty($payoutAccount->approved_at) || $payoutAccount->status === PayoutAccount::STATUS_ACTIVE) ? 'verified' : 'unverified';`
- `app/Http/Controllers/AdminPayoutAccountController.php:109: $data['approved_at'] = $this->formatDate($item->approved_at);`
- `app/Http/Controllers/AdminPayoutAccountController.php:196: if ($account->approved_at) {`
- `app/Http/Controllers/AdminPayoutAccountController.php:198: 'timestamp' => $this->formatDate($account->approved_at),`
- `app/Http/Controllers/AdminPayoutAccountController.php:233: $data['approved_at'] = $this->formatDate($account->approved_at);`
- `app/Http/Controllers/AdminPayoutAccountController.php:277: $account->approved_at = now();`
- `app/Http/Controllers/AdminWithdrawalController.php:159: 'approved_at' => $this->formatDate($item->approved_at),`
- `app/Http/Controllers/AdminWithdrawalController.php:257: if ($withdrawal->approved_at) {`
- `app/Http/Controllers/AdminWithdrawalController.php:259: 'timestamp' => $this->formatDate($withdrawal->approved_at),`
- `app/Http/Controllers/AdminWithdrawalController.php:296: 'approved_at' => $this->formatDate($withdrawal->approved_at),`
- `app/Http/Controllers/AdminWithdrawalController.php:354: $withdrawal->approved_at = now();`

### `rejected_reason` — 3 hit(s)
- `app/Http/Controllers/AdminWithdrawalController.php:276: 'description' => 'Lý do: ' . ($withdrawal->rejection_reason ?? $withdrawal->rejected_reason ?? 'Không có lý do cụ thể.'),`
- `app/Http/Controllers/AdminWithdrawalController.php:301: 'rejected_reason' => $withdrawal->rejection_reason ?: $withdrawal->rejected_reason,`
- `app/Http/Controllers/AdminWithdrawalController.php:394: $withdrawal->rejected_reason = $request->input('reason');`

### `courses.level` — 0 hit(s)
- No matches

### `object ->level` — 7 hit(s)
- `app/Repositories/Instructor/InstructorUpgradeRepository.php:147: 'level' => $profile->level,`
- `app/Repositories/Report/InstructorTopCourseRepository.php:112: 'level' => $c->level ?? 'beginner',`
- `app/Services/Instructor/InstructorUpgradeService.php:320: 'level' => $row->level,`
- `app/Services/Learning/NextLearningPathService.php:81: if (!$course || !$course->level) continue;`
- `app/Services/Learning/NextLearningPathService.php:87: $lvlVal = $levelValues[$course->level] ?? 1;`
- `app/Services/Learning/NextLearningPathService.php:90: $highestLevelStr = $course->level;`
- `app/Services/Learning/RuleBasedRecommendationService.php:105: if ($candidate->level && in_array($candidate->level, $targetLevels)) {`

### `revenues.status` — 8 hit(s)
- `app/Repositories/Instructor/InstructorRevenueRepository.php:160: revenues.status,`
- `app/Repositories/Instructor/InstructorRevenueRepository.php:166: ->groupBy('revenues.status')`
- `app/Repositories/Report/CourseAnalyticsRepository.php:76: ->where('revenues.status', 'completed');`
- `app/Http/Controllers/ReportController.php:387: ->whereIn('revenues.status', ['pending', 'available', 'scheduled', 'included_in_payout', 'paid', 'withdrawn'])`
- `app/Http/Controllers/ReportController.php:533: ->whereIn('revenues.status', ['pending', 'available', 'scheduled', 'included_in_payout', 'paid', 'withdrawn']);`
- `app/Http/Controllers/ReportController.php:680: $query->where('revenues.status', $request->query('status'));`
- `app/Http/Controllers/ReportController.php:696: 'revenues.status',`
- `app/Http/Controllers/ReportController.php:761: 'revenues.status',`

### `sale_source/sale_channel` — 18 hit(s)
- `app/Repositories/Admin/AdminDashboardRepository.php:31: return Revenue::query()->select('sale_channel', DB::raw('COUNT(*) as total_orders'), DB::raw('SUM(gross_amount) as gross_amount'), DB::raw('SUM(instructor_amount) as instructor_amount'), DB::raw('SUM(platform_fee_amount) as platform_fee_amount'))->groupBy('sale_channel')->get()->toArray();`
- `app/Repositories/Admin/AdminOrderRepository.php:12: foreach (['status', 'payment_status', 'payment_method', 'sale_channel'] as $f) {`
- `app/Repositories/Admin/AdminRevenueRepository.php:13: foreach (['instructor_id', 'course_id', 'status', 'sale_channel'] as $f) {`
- `app/Repositories/Admin/AdminRevenueRepository.php:32: ->selectRaw('COALESCE(sale_source, "unknown") as sale_channel')`
- `app/Repositories/Admin/AdminRevenueRepository.php:59: ->groupByRaw('COALESCE(sale_source, "unknown")')`
- `app/Repositories/Instructor/InstructorRevenueRepository.php:21: $hasSaleSource = \Illuminate\Support\Facades\Schema::hasColumn('revenues', 'sale_source');`
- `app/Repositories/Instructor/InstructorRevenueRepository.php:43: COALESCE(revenues.sale_source, "marketplace_default") as sale_source,`
- `app/Repositories/Instructor/InstructorRevenueRepository.php:49: 'revenues.sale_source',`
- `app/Repositories/Instructor/InstructorRevenueRepository.php:56: "marketplace_default" as sale_source,`
- `app/Repositories/Instructor/InstructorRevenueRepository.php:204: 'sale_source' => $row->sale_source,`
- `app/Repositories/Instructor/InstructorRevenueRepository.php:205: 'sale_source_label' => $labels[$row->sale_source] ?? 'Marketplace mặc định',`
- `app/Services/Admin/AdminRevenueService.php:24: 'sale_channel' => $item->sale_channel ?? 'unknown',`
- `app/Http/Controllers/ReportController.php:551: $hasSaleSource = \Illuminate\Support\Facades\Schema::hasColumn('revenues', 'sale_source');`
- `app/Http/Controllers/ReportController.php:556: COALESCE(sale_source, "marketplace_default") as sale_source,`
- `app/Http/Controllers/ReportController.php:561: ->groupBy(\Illuminate\Support\Facades\DB::raw('COALESCE(sale_source, "marketplace_default")'))`
- `app/Http/Controllers/ReportController.php:566: 'sale_source' => 'marketplace_default',`
- `app/Http/Controllers/ReportController.php:583: $source = $row->sale_source;`
- `app/Http/Controllers/ReportController.php:585: 'sale_source' => $source,`

## 10. GIT STATUS
```text
 M BE/app/Http/Controllers/AdminCategoryController.php
 M BE/app/Http/Controllers/CoursePublicController.php
 M BE/app/Http/Controllers/InteractionController.php
 M BE/app/Http/Controllers/ReportController.php
 M BE/app/Repositories/Admin/AdminCategoryRepository.php
 M BE/app/Repositories/Admin/AdminCourseRepository.php
 M BE/app/Repositories/Catalog/BannerRepository.php
 M BE/app/Repositories/Catalog/CatalogCourseRepository.php
 M BE/app/Repositories/Catalog/CategoryRepository.php
 M BE/app/Repositories/Catalog/FeaturedInstructorRepository.php
 M BE/app/Repositories/Instructor/InstructorCourseRepository.php
 M BE/app/Repositories/Instructor/InstructorLearnerRepository.php
 M BE/app/Repositories/Instructor/InstructorLessonRepository.php
 M BE/app/Repositories/Instructor/InstructorRevenueRepository.php
 M BE/app/Repositories/Interaction/InstructorQuestionRepository.php
 M BE/app/Repositories/Moderation/CourseModerationRepository.php
 M BE/app/Repositories/Report/InstructorDashboardAlertRepository.php
 M BE/app/Repositories/Report/InstructorDashboardRepository.php
 M BE/app/Repositories/Report/InstructorEnrollmentChartRepository.php
 M BE/app/Repositories/Wishlist/WishlistRepository.php
 M BE/app/Services/Admin/AdminCategoryService.php
 M BE/app/Services/Admin/AdminCourseService.php
 M BE/app/Services/Admin/AdminPayoutAccountService.php
 M BE/app/Services/Admin/AdminService.php
 D BE/app/Services/AdminService.php
 M BE/app/Services/Catalog/CatalogService.php
 M BE/app/Services/Course/CourseAvailabilityService.php
 M BE/app/Services/Course/CoursePublicService.php
 D BE/app/Services/Course/CourseViewService.php
 M BE/app/Services/Course/RelatedCourseService.php
 D BE/app/Services/CoursePublicService.php
 M BE/app/Services/Faq/FaqAdminService.php
 M BE/app/Services/Instructor/CourseChecklistService.php
 M BE/app/Services/Instructor/CourseCreditService.php
 M BE/app/Services/Instructor/InstructorCourseService.php
 M BE/app/Services/Instructor/InstructorCreditOrderService.php
 M BE/app/Services/Instructor/InstructorUpgradeService.php
 M BE/app/Services/Interaction/InstructorQuestionService.php
 D BE/app/Services/InteractionService.php
 D BE/app/Services/MarketingService.php
 M BE/app/Services/Moderation/ModerationService.php
 D BE/app/Services/ModerationService.php
 D BE/app/Services/QuizService.php
 M BE/app/Services/Report/ReportService.php
 M BE/routes/api/admin.php
 D BE/routes/api/admin.php.backup-20260731-232635
 M BE/routes/api/course.php
?? BE/.codegraph/
?? BE/_audit/
?? BE/_scripts/
```
...
```text
 ...
 BE/routes/api/admin.php                            |   2 -
 BE/routes/api/admin.php.backup-20260731-232635     | 184 -----------
 BE/routes/api/course.php                           |   1 -
 47 files changed, 189 insertions(+), 1830 deletions(-)
```
...
-            ->whereNumber('id');
         ...
         Route::get('/categories/{id}', [AdminCategoryController::class, 'show'])
             ->whereNumber('id');
diff --git a/BE/routes/api/admin.php.backup-20260731-232635 b/BE/routes/api/admin.php.backup-20260731-232635
deleted file mode 100644
index 7a041fc..0000000
--- a/BE/routes/api/admin.php.backup-20260731-232635
+++ /dev/null
@@ -1,184 +0,0 @@
-<?php
-
